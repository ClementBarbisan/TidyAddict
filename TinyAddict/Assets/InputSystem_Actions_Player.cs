...
//     version 1.19.0
//     from Assets/InputSystem_Actions_Player.inputactions
//
...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/InputSystem_Actions_Player.inputactions".
/// </summary>
/// <remarks>
...
/// </code>
/// </example>
public partial class @InputSystem_Actions_Player: IInputActionCollection2, IDisposable
{
    /// <summary>
    ...
    /// </summary>
    public @InputSystem_Actions_Player()
    {
        asset = InputActionAsset.FromJson(@"{
    ""version"": 1,
    ""name"": ""InputSystem_Actions_Player"",
    ""maps"": [
        {
            ""name"": ""Player"",
    ...
    ~@InputSystem_Actions_Player()
    {
        UnityEngine.Debug.Assert(!m_Player.enabled, "This will cause a leak and performance issues, InputSystem_Actions_Player.Player.Disable() has not been called.");
        UnityEngine.Debug.Assert(!m_UI.enabled, "This will cause a leak and performance issues, InputSystem_Actions_Player.UI.Disable() has not been called.");
    }
    ...
    {
        private @InputSystem_Actions_Player m_Wrapper;

        /// <summary>
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public PlayerActions(@InputSystem_Actions_Player wrapper) { m_Wrapper = wrapper; }
        /// <summary>
    ...
    public struct UIActions
    {
        ...
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public UIActions(@InputSystem_Actions_Player wrapper) { m_Wrapper = wrapper; }
        /// <summary>
